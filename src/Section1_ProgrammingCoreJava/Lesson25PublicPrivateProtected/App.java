...
public class App {
    public static void main(String[] args) {
        ...
        // size is protected but Section1_ProgrammingCoreJava.Lesson13ClassesAndObjects is not at the same package as Plant;
        // So, won't work
        // System.out.println(plant.size);

        // won't work because Section1_ProgrammingCoreJava.Lesson13ClassesAndObjects and Plant are in different packages, height has package-level visibility
