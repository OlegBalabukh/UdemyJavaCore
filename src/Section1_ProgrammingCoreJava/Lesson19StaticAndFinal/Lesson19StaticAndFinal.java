package Section1_ProgrammingCoreJava.Lesson19StaticAndFinal;
...
class Thing {
    ...
    public  Thing() { // this (default) constructor will be run every time new instance of a Section1_ProgrammingCoreJava.Lesson19StaticAndFinal.Thing is created
        id = count;
        count++;
    }
