package Section2_JavaCollectionsFramework.Lesson12WhichCollectionToUse;
...
public class App {
    public static void main(String[] args) {
        ...
        // Iterating over map values is very slow (over map keys - fast)
        ...
        // Keys not in a particular order, and order liable to change
